...
namespace Api.MeetingRoom.DTO
{
    public class PaginationDTO
    {
        ...
        [Range(1, 9999, ErrorMessage = "A página é um campo obrigatório e deve ser diferente de 0")]
        public int Page { get; set; }
        [Required(ErrorMessage = "A quantidade de itens por página é um campo obrigatório e deve ser diferente de 0")]
        [Range(1, 9999, ErrorMessage = "A quantidade de itens por página é um campo obrigatório e deve ser diferente de 0")]
